...
{
    public partial class GuestSerifDialog : CommonFormLibrary.BaseDialog
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public GuestSerifDialog()
        {
            InitializeComponent();
        }
        ...
        public GuestSerifDialog(int GuestID, GuestDataEntity.mt_guest_serifDataTable SerifTable)
        {
            InitializeComponent();
            ...
            _serifView.RowFilter = SerifTable.guest_idColumn.ColumnName + "=" + _guestID;
            _serifView.Sort = SerifTable.situationColumn.ColumnName + "," + SerifTable.serif_noColumn.ColumnName;
        }

        private int _guestID = 0;
        private GuestDataEntity.mt_guest_serifDataTable _table;
        ...
        /// <param name="e"></param>
        private void GuestSerifDialog_Load(object sender, EventArgs e)
        {
            this.dataGridViewList.Rows.Clear();

            foreach (DataRowView rowView in _serifView)
            {
                GuestDataEntity.mt_guest_serifRow row = (GuestDataEntity.mt_guest_serifRow)rowView.Row;
        ...
        private void buttonOK_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow row in this.dataGridViewList.Rows)
            {
                ...
                GuestDataEntity.mt_guest_serifRow newRow = _table.Newmt_guest_serifRow();
                ...
                _table.Addmt_guest_serifRow(newRow);
